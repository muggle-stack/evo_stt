...
Usage:
    python static_file_demo.py audio.wav
    python static_file_demo.py --list-backends
"""
...
def main():
    ...
    if args.list_backends:
        print(f"可用后端: {asr.ASREngine.get_available_backends()}")
        return
    ...
    config = asr.ASRConfig.sensevoice(args.model_dir)
